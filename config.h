...
#define MAX_WALKING_DIFFERENCE 50
#define MAX_WALKING_DISTANCE 120
#define MIN_WALKING_DISTANCE 180

#define TURNDISTANCE 120

#define SHARP_O_WALL_DETECTED 180
#define SHARP_W_WALL_DETECTED 180
//Digital
